...
#define COST_MV_X3_DIR(m0x, m0y, m1x, m1y, m2x, m2y, costs) \
    { \
        ...
        comlab215::num_times_sad += (comlab215::puw * comlab215::puh * 3) / 8; \
        sad_x3(fenc, \
...
#define COST_MV_X4_DIR(m0x, m0y, m1x, m1y, m2x, m2y, m3x, m3y, costs) \
    { \
        pixel *pix_base = fref + bmv.x + bmv.y * stride; \
        comlab215::num_times_sad += (comlab215::puw * comlab215::puh * 4) / 8; \
        sad_x4(fenc, \
               pix_base + (m0x) + (m0y) * stride, \
               pix_base + (m1x) + (m1y) * stride, \
               pix_base + (m2x) + (m2y) * stride, \
...
#if EN_LAB215
        comlab215::num_times_sad2 += (comlab215::puh * comlab215::puw * 3)/8;
#endif
...
#if EN_LAB215
        comlab215::num_times_sad2 += (comlab215::puh * comlab215::puw * 4)/8;
#endif
...
#if EN_LAB215
        comlab215::num_times_satd += (comlab215::puh*comlab215::puw/8);
#endif
